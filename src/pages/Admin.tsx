...
import { Loader2, LogOut, Moon, Sun, Save, Settings } from "lucide-react";
...
export default function Admin() {
  ...
  const checkAuth = async () => {
    ...
    if (!roles || roles.length === 0) {
      toast({
        variant: "destructive",
        title: "Restricted Area: Admin Access Only",
  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      <DashboardHeader
        title="Admin Panel"
        subtitle="Manage restaurant settings"
        logo={
