...
import { Loader2, TrendingUp, DollarSign, Package, Download, Clock, TrendingDown, ChefHat, RefreshCw } from "lucide-react";
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div 
                        ...
                        style={{
                          backgroundColor: index < 3 ? 'hsl(var(--primary))' : `hsl(var(--analytics-primary, var(--background)))`,
                          color: index < 3 ? 'white' : `hsl(var(--analytics-text, var(--foreground)))`,
                        }}
                      >
                        {index + 1}
                      </div>
                      <p className="font-semibold" style={{ color: `hsl(var(--analytics-text, var(--foreground)))` }}>{item.name}</p>
                    </div>
